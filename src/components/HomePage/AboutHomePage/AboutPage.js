...
export default function AboutPage() {
  return (
    ...
    <div className="cus-contact flex mt-10">
      <div className="title-contact border-none border-transperant  w-1/2">
        <h2 className="text-center text-2xl font-mono pb-5 pt-3">Coffee distribution</h2>
        ...
        <button className=" mt-8 ml-3 text-xl py-2 px-6 text-red-300 border-red-300 rounded-lg border-2">Read More</button>
      </div>
